...
export default function Home() {
  ...
  const aboutRef = useScrollReveal<HTMLElement>({ threshold: 0.2 });
  const practiceRef = useScrollReveal<HTMLElement>({ threshold: 0.2 });
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main id="main-content" className="flex-1">
        ...
        <section
          id="sobre"
          ref={aboutRef.ref}
          className={`py-16 md:py-24 bg-secondary/10 transition-all duration-700 ${
            aboutRef.isVisible
              ? 'opacity-100 translate-y-0'
              : 'opacity-0 translate-y-8'
          }`}
